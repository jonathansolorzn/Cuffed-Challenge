//
//  SwipeDeleteAction.swift
//  CuffedApp
//
//  Created by Alexis on 15/2/23.
//
...
extension View {
    func mySwipeAction(color: Color = .red,
                       icon: String = Strings.trash,
                       action: @escaping () -> Void
    ) -> some View {
        return self.modifier(MySwipeModifier(color: .red, icon: Strings.trash, action: action ))
    }
}
